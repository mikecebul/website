        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="max-w-[46rem] space-y-5">
            <h1 className="max-w-[10.5ch] font-heading text-5xl font-semibold tracking-tighter text-balance sm:text-[4.35rem] lg:text-[5.6rem]">
              Elevate Your <span className="text-(--marketing-gold)">{websiteContent.home.highlight}</span> with Modern Tech.
            </h1>
        ...
        <div className="space-y-5">
          ...
          <h1 className="max-w-5xl font-heading text-5xl leading-[0.9] tracking-[-0.08em] sm:text-6xl lg:text-[5.2rem]">
            ...
            <span className="block">
              ...
              <span className="text-(--marketing-sky)">{websiteContent.about.heading.accentSky}</span>
            </span>
          </h1>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="overflow-hidden rounded-[32px] border border-white/8 bg-[rgba(19,27,46,0.85)]">
            ...
            <div className="border-t border-white/8 px-6 py-5">
              <p className="text-sm uppercase tracking-[0.28em] text-(--marketing-gold)">Location</p>
              <p className="mt-2 text-base text-(--marketing-copy)">{websiteContent.contact.location}</p>
            </div>
          </div>
        </div>
    ...
    <MarketingPageMain>
      ...
      <section className="mx-auto mt-20 grid max-w-[1220px] gap-8 px-4 sm:px-6 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:px-12">
        <div className="space-y-6">
          <div className="rounded-[32px] border border-white/8 bg-[rgba(19,27,46,0.82)] p-8">
            ...
            <p className="mt-4 text-base leading-8 text-(--marketing-copy)">{caseStudy.challenge}</p>
          </div>
      ...
      <section className="mx-auto mt-20 max-w-[1024px] px-4 sm:px-6 lg:px-12">
        <div className="rounded-[34px] border border-white/8 bg-[linear-gradient(155deg,rgba(34,42,61,1),rgba(19,27,46,1))] px-8 py-12 text-center shadow-[0_30px_80px_rgba(0,0,0,0.35)] sm:px-12">
          ...
          <h2 className="mt-3 font-heading text-3xl tracking-[-0.05em] sm:text-4xl">{caseStudy.ctaHeading}</h2>
...
export function MarketingBlogNewsletterCard() {
  return (
    <div className="rounded-[28px] border border-(--marketing-gold)/30 bg-(--marketing-gold) px-6 py-7 text-(--marketing-gold-foreground)">
      <p className="text-sm uppercase tracking-[0.28em] opacity-70">{websiteContent.blogPage.newsletterEyebrow}</p>
      <h3 className="mt-3 font-heading text-2xl tracking-[-0.04em]">{websiteContent.blogPage.newsletterTitle}</h3>
        ...
        {websiteContent.services.map((service) => {
          ...
          return (
            ...
            >
              ...
              <div className={cn('grid grid-cols-[auto_minmax(0,1fr)] items-start gap-5', service.featured && 'pt-8')}>
                ...
                <div className="min-w-0 pt-1 text-right">
                  ...
                  <div className="mt-3 flex items-end justify-end gap-2">
                    ...
                    <span className="pb-1 text-base text-(--marketing-copy)">{service.priceSuffix}</span>
                  </div>
                  {service.priceDetail ? (
              ...
              <div className="mt-14 flex flex-1 flex-col">
                ...
                <p className="mt-4 text-base leading-8 text-(--marketing-copy)/92">{service.description}</p>
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-xs uppercase tracking-[0.22em] text-(--marketing-sky)">{service.eyebrow}</p>
                  <h2 className="mt-2 font-heading text-2xl tracking-[-0.04em]">{service.headline}</h2>
                  <p className="mt-2 text-sm leading-7 text-(--marketing-copy)">{service.description}</p>
                </div>
              </div>
            )
          })}
...
function MarketingLocalRootsSection() {
  return (
    <section className="mx-auto mt-20 grid max-w-[1220px] gap-8 px-4 sm:px-6 lg:grid-cols-[minmax(320px,0.95fr)_minmax(0,1.05fr)] lg:items-center lg:px-12">
      <div className="overflow-hidden rounded-[32px] border border-white/8 bg-(--marketing-panel)">
        <img alt="Charlevoix harbor view" className="h-[320px] w-full object-cover" src={websiteContent.images.hero} />
      </div>
      <div className="space-y-5">
...
function MarketingPageHero({
  ...
  return (
    <section className="mx-auto max-w-[1220px] px-4 pt-6 sm:px-6 lg:px-12">
      ...
      <p className="mt-6 max-w-3xl text-base leading-8 text-(--marketing-copy) sm:text-lg">{body}</p>
    </section>
  )
}
  ...
  return (
    <section className="mx-auto mt-20 max-w-[1024px] px-4 sm:px-6 lg:px-12">
      <div className="rounded-[34px] border border-white/8 bg-[linear-gradient(155deg,rgba(34,42,61,1),rgba(19,27,46,1))] px-8 py-12 text-center shadow-[0_30px_80px_rgba(0,0,0,0.35)] sm:px-12">
        ...
        <h2 className="mt-3 font-heading text-3xl tracking-[-0.05em] sm:text-4xl">{websiteContent.cta.title}</h2>
        <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-(--marketing-copy)">
          {websiteContent.cta.body}
        </p>
        <div className="mt-8 flex justify-center">
          <MarketingButtonLink href={websiteContent.cta.buttonHref}>{websiteContent.cta.buttonLabel}</MarketingButtonLink>
        </div>
      </div>
    </section>
  )
      ...
      <div className="mx-auto flex max-w-[1280px] items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-12">
        ...
        <nav className="hidden flex-wrap items-center justify-center gap-2 text-sm text-(--marketing-copy) md:flex">
          {websiteContent.headerNav.map((item) => (
            <MarketingRouteLink key={item.href} active={pathname === item.href} href={item.href} label={item.label} />
          ))}
          <NavigationMenu
            align="center"
            className="flex-none"
                          ...
                          <div className="flex items-start gap-3">
                            <span
                              className={cn(
                                ...
                                isActiveCaseStudy && 'bg-[rgba(255,236,185,0.1)] ring-1 ring-(--marketing-gold)/20',
                              )}
                            >
                              <CaseStudyIcon className="size-5" />
                            </span>
                            <div className="min-w-0">
                              <p className="text-[11px] uppercase tracking-[0.2em] text-(--marketing-sky)">{caseStudy.eyebrow}</p>
                              <p
                                className={cn(
      ...
      <DrawerContent className="h-full w-[24rem] border-l border-white/10 bg-[rgba(7,16,31,0.98)] text-(--marketing-heading) sm:max-w-none">
        ...
        <div className="flex h-full flex-col gap-10 overflow-y-auto px-6 py-8">
              ...
              <DrawerClose key={item.href} asChild>
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === item.href && 'border-(--marketing-gold)/30 bg-white/4 text-(--marketing-gold)',
                  )}
                >
                  {item.label}
                </Link>
          ...
          <div className="space-y-4">
            <p className="text-xs uppercase tracking-[0.28em] text-(--marketing-sky)">Case Studies</p>
              ...
              {websiteContent.caseStudies.map((caseStudy) => {
                ...
                return (
                  <DrawerClose key={caseStudy.slug} asChild>
                    ...
                    >
                      <p className="text-sm uppercase tracking-[0.2em] text-(--marketing-sky)">{caseStudy.eyebrow}</p>
                      <p className="mt-2 font-heading text-xl tracking-[-0.04em] text-(--marketing-heading)">
                        {caseStudy.navTitle}
                      </p>
                      <p className="mt-2 text-sm leading-6 text-(--marketing-copy)">{caseStudy.navDescription}</p>
                    </Link>
                  </DrawerClose>
                )
              })}
...
function MarketingEyebrow({ children }: { children: ReactNode }) {
  return <p className="text-xs font-medium uppercase tracking-[0.32em] text-(--marketing-sky)">{children}</p>
}
...
function MarketingStatCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-[20px] border border-white/8 bg-[rgba(19,27,46,0.82)] px-5 py-4">
      ...
      <p className="mt-2 font-heading text-lg tracking-[-0.03em] text-(--marketing-heading)">{value}</p>
    </div>
  )
}
  ...
  return (
    <footer className="border-t border-white/6 bg-[rgba(7,16,31,0.96)]">
      <div className="mx-auto grid max-w-[1280px] gap-12 px-4 py-14 sm:px-6 lg:grid-cols-[minmax(0,1.2fr)_220px_220px] lg:px-12">
        <div className="flex flex-col gap-6">
          <div className="space-y-3">
            <p className="font-heading text-2xl tracking-[-0.05em] text-(--marketing-heading)">{websiteContent.site.name}</p>
            <p className="max-w-sm text-sm leading-7 text-(--marketing-copy)">{websiteContent.footer.description}</p>
          </div>
          ...
          <p className="text-sm text-(--marketing-copy-soft)">© {new Date().getFullYear()} {websiteContent.site.legalName}. All rights reserved.</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-3 text-sm text-(--marketing-copy)">
            {websiteContent.footer.servicesLinks.map((link) => (
              <Link key={link.href} className="transition-colors hover:text-(--marketing-heading)" href={link.href}>
                {link.label}
              </Link>
            ))}
          </div>
